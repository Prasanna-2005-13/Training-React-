...
function App() {
  let ele = ReadableByteStreamController.createElement("div" ,{className: "App"}
  ...
  render() {
    return (
      <div > 
        ...
        address={{city:"Hyderabad" , area:"Secunderabad"}}
        sendFun={function(){alert("Hello I am Prasanna")}}
        />
        <FBCPropsEx
        username="Abhinay"
        isMarried={true}
...
import React, {stateexample} from 'react'
import CBCStateEx from './stateexample/CBCStateEx'


export default class App extends stateexample {
  render() {
    return (
      <div className='app'>
      <CBCStateEx/>
